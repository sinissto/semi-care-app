      ...
      <div className="container mx-auto">
        <div className="flex items-center justify-center gap-6 ">
          <div className=" flex flex-col items-center text-center">
            ...
            <h1 className="text-5xl/[1.05] text-grey-primary font-primary font-bold -tracking-[0.5px] mb-10 lg:text-6xl max-w-3xl">
              {services.title}
            </h1>
            {services.description.map((description, index) => (
              <p
                key={index}
                className="max-w-3xl text-xl/normal text-grey-primary mb-4 lg:text-xl "
              >
                {description}
              </p>
            ))}
